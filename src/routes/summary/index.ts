...
summaries.put('/:tone', guard('editor'), describeRoute(upsertArticleSummaryDocs), vValidator('param', SummaryToneParamsSchema), vValidator('json', UpsertSummarySchema), async (c) => {
    const { id: externalId, tone } = c.req.valid('param')
