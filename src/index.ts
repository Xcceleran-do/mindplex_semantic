...
app.route('/v1/ingest', ingest) // protected by guard()
app.route('/v1/articles', articles) // patch and delete protected by guard()
app.route('/v1/search', search)
app.route('/v1/users', usersRoute) // patch and delete protected by guard()
